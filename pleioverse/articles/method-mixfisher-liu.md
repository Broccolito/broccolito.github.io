...
This variant evaluates the heterogeneity tail by the Liu chi-square
...
The Liu variant keeps the mixture-Fisher statistic but uses Liu moment
matching for the heterogeneity component’s quadratic-form tail.
...
Good for the same two-component question when a fast Liu approximation
is acceptable.
...
pleio <- run_mixfisher_liu(pleio)
head(pleio@results$mixfisher_liu)
```

## Implementation Files

- R wrapper: `R/run_mixfisher_liu.R`
