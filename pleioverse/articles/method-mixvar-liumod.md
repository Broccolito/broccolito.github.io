...
modified-Liu chi-square moment-matching approximation.
...
The modified-Liu variant of MixVar uses the package’s modified
moment-matching approximation for the blended quadratic-form tail.
...
Good when the modified-Liu variance-scale blend is desired.
...
pleio <- run_mixvar_liumod(pleio)
head(pleio@results$mixvar_liumod)
```

## Implementation Files

- R wrapper: `R/run_mixvar_liumod.R`
