...
The Liu variant of MixSD uses moment matching for the
standard-deviation-weighted blend.
...
Good when a fast Liu approximation to the MixSD blend is desired.
...
pleio <- run_mixsd_liu(pleio)
head(pleio@results$mixsd_liu)
```

## Implementation Files

- R wrapper: `R/run_mixsd_liu.R`
