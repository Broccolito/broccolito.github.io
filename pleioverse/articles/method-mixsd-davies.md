...
MixSD fixes the burden/heterogeneity blend using
standard-deviation-based weighting rather than variance-based weighting.
...
Good when a less variance-dominated fixed blend is desired.
...
pleio <- run_mixsd_davies(pleio)
head(pleio@results$mixsd_davies)
```

## Implementation Files

- R wrapper: `R/run_mixsd_davies.R`
