...
Result column: `mixfisher_davies`
...
The mixture-Fisher family combines evidence from a mean-effect component
and a heterogeneity component, then combines their p-values with
Fisher’s rule.
...
Good when either a mean-effect component or a heterogeneity component
may be active and Davies tail inversion is desired.
...
pleio <- run_mixfisher_davies(pleio)
head(pleio@results$mixfisher_davies)
```

## Implementation Files

- R wrapper: `R/run_mixfisher_davies.R`
